...
import com.shiny.ucenter.common.entity.ElementExample.Criteria;
import com.shiny.ucenter.common.entity.ElementExample.Criterion;
...
public class ElementSqlProvider {
    ...
    public String selectByExample(ElementExample example) {
        SQL sql = new SQL();
    ...
    protected void applyWhere(SQL sql, ElementExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
