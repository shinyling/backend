...
import com.shiny.ucenter.common.entity.UserGroupRoleExample.Criteria;
import com.shiny.ucenter.common.entity.UserGroupRoleExample.Criterion;
...
public class UserGroupRoleSqlProvider {
    ...
    public String selectByExample(UserGroupRoleExample example) {
        SQL sql = new SQL();
    ...
    protected void applyWhere(SQL sql, UserGroupRoleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
