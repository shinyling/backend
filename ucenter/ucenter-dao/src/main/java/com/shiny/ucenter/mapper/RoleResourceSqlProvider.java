...
import com.shiny.ucenter.common.entity.RoleResourceExample.Criteria;
import com.shiny.ucenter.common.entity.RoleResourceExample.Criterion;
...
public class RoleResourceSqlProvider {
    ...
    public String insertSelective(RoleResourceKey record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("role_resource");
