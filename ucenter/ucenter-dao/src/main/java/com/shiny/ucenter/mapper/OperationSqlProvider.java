...
import com.shiny.ucenter.common.entity.OperationExample.Criteria;
import com.shiny.ucenter.common.entity.OperationExample.Criterion;
...
public class OperationSqlProvider {
    ...
    public String selectByExample(OperationExample example) {
        SQL sql = new SQL();
    ...
    protected void applyWhere(SQL sql, OperationExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
